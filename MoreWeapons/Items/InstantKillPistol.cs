...
[Automatic]
[Item(
    Id = (uint)CustomItemType.InstantKillPistol,
    Name = nameof(CustomItemType.InstantKillPistol),
    BasedItemType = ItemType.GunUSP
    )]
public class InstantKillPistol : MoreWeaponsItemHandler
{
    ...
    public override void OnShoot(ShootEvent ev)
    {
        ...
        else
        {
            ...
            ev.Target.PlayerEffectsController.UseMedicalItem(ItemType.SCP018);
        }
